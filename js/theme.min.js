			...
			n &&
				n.addEventListener('submit', function(a) {
					...
					a.preventDefault(),
						...
						(o = e.querySelector('[name="navPosition"]:checked')
							.value),
						(r = e.querySelector('[name="sidebarColor"]:checked')
							.value),
